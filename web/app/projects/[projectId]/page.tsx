...
const ProjectDetailPage = () => {
  ...
  const projectId = params.projectId ? parseInt(params.projectId as string, 10) : null; // Extract and parse project ID
  ...
  const { data, loading: queryLoading, error } = useQuery(GET_PROJECT_DETAILS, {
  ...
  if (error) {
      ...
      return (
          <div className="p-6">
              <p className="text-red-500">Error loading project details: {error.message}</p>
          </div>
      );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-6">
      ...
      <div className="mb-6">
        <Link href="/dashboard" >
          <Button variant="outline">← Back to Dashboard</Button> {/* Shadcn button with outline variant */}
        </Link>
      </div>
      ...
      <div className="container mx-auto">
        <h2 className="text-3xl font-semibold mb-6 text-gray-800 dark:text-gray-200">Deployments</h2>
